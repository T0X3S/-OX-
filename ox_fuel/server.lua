...
if Config.versionCheck then
    lib.versionCheck('overextended/ox_fuel')
end
...
ESX.RegisterServerCallback('ox_fuel:getBankMoney', function(src, cb)
...
RegisterNetEvent('ox_fuel:pay', function(price, fuel, netid)
    ...
    if hasEnoughMoney then
        if useMoney then
            ...
            xPlayer.setAccountMoney('bank', xPlayer.getAccount('bank').money - price)
        end
